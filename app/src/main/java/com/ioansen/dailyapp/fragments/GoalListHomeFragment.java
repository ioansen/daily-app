...
import com.ioansen.dailyapp.repositories.TodayGoalsRepository;
import com.ioansen.dailyapp.adapters.SwipeAndDragHelper;
import com.ioansen.dailyapp.adapters.GoalsAdapter;
 ...
 * @since 1.0
 */
public class GoalListHomeFragment extends Fragment {
     ...
     * and retrieved with {@link com.ioansen.dailyapp.viewmodels.DayViewModel#getToday}*/
    private Day today;
    ...
    public interface OnFragmentInteractionListener {
        ...
        /**Called when a goal is removed from dailyapp's list.
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof GoalListHomeFragment.OnFragmentInteractionListener) {
            listener = (GoalListHomeFragment.OnFragmentInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement GoalListHomeFragment.Listener");
        }
    }
    @Override
    public void onPause() {
