...
import com.ioansen.today.fragments.TodayActivityFragment;
...
public class TodayActivity extends AppCompatActivity
    implements TodayActivityFragment.OnFragmentInteractionListener {
    ...
    * 2 - edit goal */
    ...
    private TodayActivityFragment todayGoalsFrag;
    ...
    * instead on on very update*/
    ...
    /*this is the day object for the today day
    * provided by a dayViewModel*/
    ...
    private void setupNavigationView() {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id){
                    case R.id.nav_goals:
                        intent = new Intent(TodayActivity.this, CollectionActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.nav_calendar:
                        intent = new Intent(TodayActivity.this, CalendarActivity.class);
                        startActivity(intent);
                        break;
                }
                DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
    ...
    private void setupFragment() {
        todayGoalsFrag = (TodayActivityFragment) getSupportFragmentManager().findFragmentById(R.id.goals_fragment);
    }
    ...
    public void onRemoveGoalFromToday(final int position, final Goal goal) {
        ...
        removeGoal = goal;
        remove = true;
        Snackbar snackbar = Snackbar.make(findViewById(R.id.coordinator_root_layout), "\"" + goal.getName() + "\" removed from today" ,  Snackbar.LENGTH_LONG);
    ...
    public void onClickRecursive(View view) {
        ...
        recursiveRepo.setOnLoadFinishedListener(new GoalsRepository.OnLoadFinishedListener() {
            ...
            public void onLoadFinished(List<Goal> goals) {
                ...
                new MaterialDialog.Builder(TodayActivity.this)
