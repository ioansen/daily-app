...
public class AddGoalActivity extends AppCompatActivity
    ...
    private void setupExtras(){
        ...
        if (extras != null) {
           ...
           /* id = extras.getLong("id");
            ...
            isRecursive = extras.getBoolean("isRecursive");
    ...
    public void onClickDone(View view) {
        ...
        if ( name.equals("")){
           ...
           /* List<Label> selectedLabels = goalsLabelRepository.getLabels();
            *//*remove the fake label*//*
            selectedLabels.remove(selectedLabels.size()-1);

            *//*setup added labels by selected - entered*//*
            List<Label> addedGoalLabels = new ArrayList<>(selectedLabels);
            addedGoalLabels.removeAll(enteredLabels);
            *//*setup removed labels by entered - selected*//*
            List<Label> removedGoalLabels = new ArrayList<>(enteredLabels);
            removedGoalLabels.removeAll(selectedLabels);

            Label[] addedLabelsArray = new Label[addedGoalLabels.size()];
            new TodayDatabaseHelper.InsertGoalLabelsTask().setGoal(id).execute(addedGoalLabels.toArray(addedLabelsArray));
            Label[] removedLabelsArray = new Label[removedGoalLabels.size()];
            new TodayDatabaseHelper.RemoveGoalLabelsTask().setGoal(id).execute(removedGoalLabels.toArray(removedLabelsArray));*/
            ...
            returnIntent.putExtra("importance", importance);
            returnIntent.putExtra("difficulty", difficulty);
            returnIntent.putExtra("isRecursive", isRecursive);
